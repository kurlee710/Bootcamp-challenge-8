...
class Cli {
    ...
    createTruck() {
        inquirer
            ...
            const truck = new Truck(Cli.generateVin(), answers.make, answers.model, answers.color, parseInt(answers.year), parseInt(answers.weight), parseInt(answers.topSpeed), [], parseInt(answers.towingCapacity));
    ...
    createMotorbike() {
        inquirer
            ...
            const motorbike = new Motorbike(Cli.generateVin(), answers.make, answers.model, answers.color, parseInt(answers.year), parseInt(answers.weight), parseInt(answers.topSpeed), [
